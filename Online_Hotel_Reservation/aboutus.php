	...
	<div style = "margin-left:0;" class = "container">
		<div class = "panel panel-default">
			<div class = "panel-body">
				...
				<p style = "position:relative; float:left; width:850px; text-align: justify;">	In addition to its remarkable features and magnificence, it's important to note it is a database project. This project is the collaborative effort of three talented individuals: M. Saad Abdullah Malik (BSE221099), Abdul Sammad (BSE221057), and Sheikh Saif ur Rehman (BSE221090). As students of 
				Software Engineering at CUST (Capital University of Science and Technology), we have embarked on this project to showcase our skills and knowledge in database management. Through particular planning and implementation, we have strived to create a comprehensive and efficient database system that supplies the specific needs of the hotel industry. By combining our expertise 
				in software engineering with our passion for creating exceptional user experiences, we aim to deliver a strong and user-friendly database solution that enhances the hotel's operations and customer satisfaction.</p>
				<img style = "float:right;" src = "images/about.avif" width = "250px" height = "250px" />
				<br style = "clear:both;" />
				<br />
				<br />
				...
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label>Small Size Bed</label> <label style = "color:red;">Price 2,000 Rs</label></center>
				</div>
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label style = "color:red;">Price 800 Rs</label></center>
				</div>
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label>1 Medium Size Bed</label> <label style = "color:red;">Price 2,400 Rs </label></center>
				</div>
				<br style = "clear:both;"/>
				<br />
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label>2 Medium Size Bed</label> <label style = "color:red;">Price 2,800 Rs </label></center>
				</div>
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label>Matrimonial</label> <label style = "color:red;">Price 3,800 Rs </label></center>
				</div>
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					...
					<center><label>Matrimonial</label> <label style = "color:red;">Price 4,000 Rs</label></center>
				</div>
				<br style = "clear:both;"/>
				<br />
				<br />
				<strong><h3>Services and Supplies</h3></strong>
				<ul>
