				...
				?>
					<div class = "well" style = "height:300px; width:100%;">
						...
						<div style = "float:left; margin-left:10px;">
							...
							<h4 style = "color:#00ff00;"><?php echo "Price: ".$fetch['price']." Rs"?></h4>
							<br /><br /><br /><br /><br /><br />
							<button class="custom-button" onclick="location.href = 'add_reserve.php?room_id=<?php echo $fetch['room_id']?>'">Reserve</button>
						</div>
					</div>
				<?php
					}
